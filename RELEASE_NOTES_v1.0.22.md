# EMX Desktop Flow v1.0.22

## Cursor and background library polish

- Newly installed managed cursor-pack pointers now appear in the Cursor Test Zone immediately after checking for updates, so each pointer can be previewed before applying the full pack.
